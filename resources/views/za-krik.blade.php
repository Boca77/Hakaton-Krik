...
<div class="container" style="min-height: 80vh;">
  ...
  <div class="row align-items-center pt-5 pb-5">
    ...
    <div class="col-12 col-md-6 mb-3 mb-md-0">
      <img src="{{ asset('images/students108126313-2048x2048.jpg') }}" alt="Image description" class="img-fluid rounded-5">
    </div>

    <!-- Second Column (Text) -->
    <div class="col-12 col-md-6">
      <p class="fw-bold fs-5">Центарот за младинскиот активизам Крик е невладина, непрофитна оргнанизација основана од страна на млади луѓе, предводена од млади луѓе и работи за млади луѓе.</p>
      <p class="fs-5">Целната група со која КРИК работи се сите луѓе Lorem ipsum dolor sit amet consectetur adi
        pisicing elit. Similique dolor iure consectetur ea ipsam qui adipisci neque laudantium quisquam incidunt obcaecati maxime ad officiis assumenda, id doloribus pariatur nulla repudiandae.</p>
    </div>
  </div>
</div>
<div class="container">
...
<div class="col-12 col-md-8">
      <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Deleniti illum dolorem libero omnis minima eum magnam aut enim dicta tenetur et, fuga assumenda sunt iure possimus consequuntur? Suscipit, fugit illum.</p>
    </div>
</div>
</div>
<hr class="my-4" style="border: 1px solid #000;">
...
<div class="col-12 col-md-8">
      <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Lorem ipsum dolor sit amet consectetur adipisicing elit. Unde quia, itaque natus deserunt, incidunt fuga fugiat recusandae delectus molestias laborum eligendi! Molestias tenetur deleniti itaque, quasi corrupti cumque laborum a!Deleniti illum dolorem libero omnis minima eum magnam aut enim dicta tenetur et, fuga assumenda sunt iure possimus consequuntur? Suscipit, fugit illum.</p>
    </div>
</div>
</div>
</div>
