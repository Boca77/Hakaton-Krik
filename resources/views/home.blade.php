...
@section('content')
<section class="header" style="background-image: url('{{ asset("images/homepage/herosection.jpg") }}'); height: 100vh;">
    <div class="container position-relative">
        <div class="row justify-content-center">
            <h1 class="text-center font_headings mt-5">ПРОМЕНАТА ДОАЃА ОД МЛАДИТЕ</h1>
        </div>
        <div class="row justify-content-center">
            <h2 class="font_headings fw-bold text-center">Кои Сме Ние?</h2>
        ...
        <div class="row justify-content-center mt-4">
            <a href="" class="text-center btn btn-info font_headings rounded-pill p-3 fw-bold button w-25">Повеќе За Нас</a>
        </div>
        <div class="container position-absolute info_board mt-5">
            <div class="row">
                <div class="col-6 bg-black rounded-start-5 p-5">
                    <h3 class="text-warning font_headings">НАСКОРО</h3>
                    <h4 class="text-white font_headings my-5">Нижеме заедно</h4>
...
<section class="news w-100">
    <div class="container mt-5">
        <h2 class="fw-bold font_headings">Најнови вести</h2>
